...
## Partial support
By default, they support the  standart encryption, but they allow you to add exceptions. Servers allow you to use a self-signed certificate for part of connections.
