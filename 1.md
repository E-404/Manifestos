...
## Partial support
By default, they support the  standart  TLS encryption, but they allow you to add exceptions. Servers allow you to use a self-signed certificate for part of connections.

* disroot.org [(notice)](https://github.com/E-404/Manifestos/pull/5)
*  blabber.de 
