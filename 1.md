...
* disroot.de - The server refused to sign the manifesto, because it considered that the manifesto would hit the reputation of the server as a server protesting against any manifestos. Nevertheless, the server 
