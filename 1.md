...
*  blabber.de - The administrator says that unverified certificates are safer than verified certificates. To verify unverified certificates, he suggested using manual verification through email with each with of tens thousands of servers. (WAT?)
